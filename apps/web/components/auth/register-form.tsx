    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="space-y-1.5">
                <label className="text-sm font-medium text-slate-300">Workspace / Team Name</label>
            ...
            <div className="text-center mt-4 text-sm text-slate-400">
                ...
                <Link href="/login" className="text-[#3BA4F5] hover:text-[#5AB5F7] font-medium transition-colors">
                    Sign in
                </Link>
            </div>
        </form>
